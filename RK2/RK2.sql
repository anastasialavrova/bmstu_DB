...
INSERT INTO Visitor (Vno, Vname, Vyear, Adress, Email) VALUES (10, 'ФИО_Vis_10', 2005, 'Adress1', 'yandex@gmail.com')

delete Visitor where Vno = 19
...
delete from Visitor where Vno = 1
...
create procedure cursor_proc as
declare @cursor cursor
set @cursor = cursor scroll
for 
select LRname, Job 
from LDB join Lecturers on LDB.LRno = Lecturers.LRno - 1000
where LDB.price > 4000
open @cursor
